...
$services = [
    // عيادة الجلدية والليزر (dermatology)
    ...
    // عيادة الباطنية (internal)
    "عيادة الباطنية" => [
        "الباطنية"
    ],
    
    // عيادة النساء والولادة (gynecology)
    "عيادة النساء والولادة" => [
        "النساء و الولادة   "
    ],
    
    // الخدمات الأخرى التي لم يكن لها خدمات فرعية محددة في كود JavaScript
    "عيادة الاطفال" => [],
    "الطب العام" => [],
    "قسم الطوارئ" => [],
    "قسم الأشعة" => [],
            ...
            form.addEventListener('submit', async function(e) {
                ...
                formData.append('service', serviceInput.value);
                 ...
                 formData.append('date_and_time', date_and_time);
                  ...
                  let message = `لديك تسجيل جديد باسم ${nameInput.value} رقم جوال ${phoneValue} خدمة ${serviceInput.value} حملة  ${ad_name}مصدر التسجيل  ${ad_source}`;
