...
//$result = send_with_wapi($token, $profile_id,'966568430828@c.us', $message."  ".$is_me );
...
$result = send_with_wapi($token, $profile_id,$chat_id,$last_message[1]."replay");
