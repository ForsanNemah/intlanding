...
$message="  شكرا لتسجيل دخولك في متجر كورنو  كود الخصم الخاص بك corno2025 ";
...
$customer_phone=extractMobileNumber($data);
    ...
    $result = send_with_wapi($wapi_token, $wapi_profile_id, "120363399365744760@g.us"," تم تسجيل الدخول الى المتجر من قبل العميل".$customer_phone);
